...
// fully detached from Glash's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Glash's process
// group.
...
// from Glash's session and controlling terminal.
//
