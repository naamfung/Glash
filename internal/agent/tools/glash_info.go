...
//go:embed glash_info.md
var glashInfoDescription string

type GlashInfoParams struct{}

func NewGlashInfoTool(
	...
	return fantasy.NewAgentTool(
		GlashInfoToolName,
		glashInfoDescription,
		func(ctx context.Context, _ GlashInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildGlashInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildGlashInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
