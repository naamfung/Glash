...
func TestGlashInfo_MinimalConfig(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/glash/glash.json",
		"/project/.glash/glash.json",
	)
	output := buildGlashInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/glash/glash.json")
	require.Contains(t, output, "/project/.glash/glash.json")
}

func TestGlashInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildGlashInfo(cfg, mgr, nil, nil, nil)
...
func TestGlashInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.glash",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.glash")
	require.Contains(t, output, "debug = true")
}

func TestGlashInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildGlashInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildGlashInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestGlashInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "glash.json")
	...
	output := buildGlashInfo(store, nil, nil, nil, nil)
...
func TestGlashInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestGlashInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
