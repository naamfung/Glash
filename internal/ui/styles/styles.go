...
type Styles struct {
	...
	// Glash's background. Defining them here keeps output readable and
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "GLASH" gradient
		LogoGradFromColor color.Color    // "GLASH" wordmark gradient start
		LogoGradToColor   color.Color    // "GLASH" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradToColor   color.Color    // Small "Glash" wordmark gradient end
	}
