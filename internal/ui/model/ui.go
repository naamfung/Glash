...
import (
	...
	agenttools "github.com/charmbracelet/glash/internal/agent/tools"
	...
	"github.com/charmbracelet/glash/internal/ui/completions"
	...
	"github.com/charmbracelet/glash/internal/ui/notification"
...
func (m *UI) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		text := fmt.Sprintf("Glash update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			text = fmt.Sprintf("This is a development version of Glash. The latest version is v%s.", msg.LatestVersion)
		}
		ttl := 10 * time.Second
...
func (m *UI) Draw(scr uv.Screen, area uv.Rectangle) *tea.Cursor {
	...
	if os.Getenv("GLASH_UI_DEBUG") == "true" {
...
func (m *UI) View() tea.View {
	...
	v.WindowTitle = "glash " + home.Short(m.com.Workspace.WorkingDir())
...
// renderLogo renders the Glash logo with the given styles and dimensions.
