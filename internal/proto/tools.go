...
// the UI asserts on.
import "github.com/charmbracelet/glash/internal/agent/tools"
...
// ShellPermissionsParams represents the permission parameters for the shell tool.
type ShellPermissionsParams = tools.ShellPermissionsParams
