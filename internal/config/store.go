...
import (
	...
	hyperp "github.com/charmbracelet/glash/internal/agent/hyper"
	...
	"github.com/charmbracelet/glash/internal/oauth/hyper"
...
type ConfigStore struct {
	...
	globalDataPath     string   // ~/.local/share/glash/glash.json
	workspacePath      string   // .glash/glash.json
...
// two glash instances (or two goroutines) refresh concurrently with the
